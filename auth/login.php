                ...
                if ($result->num_rows > 0) {
                    ...
                    if (password_verify($password, $row['password'])) {
                        ...
                        if ($role === 'admin') {
                            ...
                            header('Location: /book/admin/dashboard.php');
                            exit();
                        } elseif ($role === 'user') {
                            if ($submission_count > 0) {
                                ...
                                header('Location: /book/user/up.form.appointment.php');
                            }
                            exit();
                        } else {
...
<head>
    ...
    <title>GradEase: TUPV Document Scheduler</title>
...
<body class="flex items-center justify-center min-h-screen bg-gray-100">
    <div class="w-full max-w-md p-8 space-y-8 bg-white rounded-lg shadow-lg">
        <div class="flex flex-col items-center">
            <img class="w-24 h-24 mb-4" src="/book/assets/img/tup-logo.png" alt="Logo">
            <h1 class="text-3xl font-bold text-gray-900">GradEase</h1>
            <p class="text-gray-600">TUPV Document Scheduler</p>
        </div>
        ...
        <form class="space-y-6" action="" method="POST">
            <div class="rounded-md shadow-sm">
                <div>
                    ...
                    <input id="username" name="username" type="text" value="<?php echo htmlspecialchars($username ?? ''); ?>" required class="block w-full px-3 py-2 mt-1 border rounded-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
        ...
        <div class="flex items-center justify-between">
            <div class="text-sm">
                <a href="forgot-password.html" class="font-medium text-red-600 hover:text-red-500">Forgot Password?</a>
            </div>
        </div>
        <div class="text-center">
            <p class="text-sm text-gray-600">Don’t have an account? <a href="register.php" class="font-medium text-red-600 hover:text-red-500">Register</a></p>
        </div>
    </div>
    <script>
