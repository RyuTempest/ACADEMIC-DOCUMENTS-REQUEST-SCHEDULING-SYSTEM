                ...
                <ul>
                    ...
                    <li class="submenu"> <a href="#"><i class="fas fa-suitcase"></i> <span> Appointments </span> <span class="menu-arrow"></span></a>
                        <ul class="submenu_class" style="display: none;">
                            <li><a href="/user/up.form.appointment.php" id="make-appointment">Schedule an Appointment</a></li>
                            <li><a href="/user/pending.appointment.php"> All Appointment </a></li>
                        </ul>
                    </li>
                    <li class="submenu"> <a href="#"><i class="fas fa-book"></i> <span> Documents</span> <span class="menu-arrow"></span></a>
                        <ul class="submenu_class" style="display: none;">
                            <li><a href="/user/pending.documents.php"> Pending </a></li>
                            <li><a href="/user/finish.documents.php"> Finished </a></li>
                        </ul>
                    </li>
                    <li> <a href="/user/history.php"><i class="fe fe-table"></i> <span>History</span></a> </li>
                    <li> <a href="/user/notification.php"><i class="far fa-bell"></i> <span> Notifications </span></a></li>
                </ul>
            </div>
        </div>
    </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="col-xl-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-9">
                                                <input type="text" class="form-control" name="birth_date" value="<?php echo str_replace('-', ' ', date('d M Y', strtotime($birth_date))); ?>" readonly>
                                            </div>
                                        </div>
                                    </div>
                                </div>
